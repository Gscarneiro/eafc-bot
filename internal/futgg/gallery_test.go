...
func TestGalleryCatalogNormalizaTagsETiers(t *testing.T) {
	...
	if len(sets) != 1 || sets[0].RequiredCards != 5 || sets[0].Thresholds[galeria.GradeS] != 2000 {
