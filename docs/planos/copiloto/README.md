...
| 04 | [Plano de mercado e ledger](04-plano-mercado-e-ledger.md) | plano global de capital, watchlist e ledger | 01, 02, 03 | concluída |
| 05 | [Rating, Insights e memória](05-rating-insights-e-memoria.md) | notas explicáveis e histórico do clube | 01, 04 | concluída |
| 06 | [Solver consultivo de SBC](06-solver-sbc-consultivo.md) | soluções locais validadas e exportáveis | 01, 02, 05 | concluída |
| 07 | [Agenda e experiência](07-agenda-de-decisoes-e-experiencia.md) | faixa de decisão, navegação e acessibilidade | 02–06 | concluída |
| 08 | [Importação e companion local](08-importacao-e-companion-local.md) | importação manual e acesso local endurecido | 01, 07 | concluída |
| 09 | [Feedback e calibração](09-feedback-backtest-e-calibracao.md) | backtest temporal e revisão de perfis | 04–08 | concluída |
