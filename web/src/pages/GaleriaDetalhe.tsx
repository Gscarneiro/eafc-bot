    ...
    <div className="detail-grid">
      <section className="panel">
        ...
        <div className="panel-body">
          ...
          <p className="hint">Cobertura: {data.evaluation.coverage || "desconhecida"}.{data.evaluation.max_proven ? " máximo comprovado." : " melhor combinação encontrada."} Estados avaliados: {data.evaluation.states ?? "—"}.</p>
