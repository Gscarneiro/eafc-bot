...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("POST /api/evolucoes/caminhos/salvos", s.guardLocalWrite(s.handleSavedEvolutionPathCreate))
	mux.HandleFunc("DELETE /api/evolucoes/caminhos/salvos/{id}", s.guardLocalWrite(s.handleSavedEvolutionPathDelete))
